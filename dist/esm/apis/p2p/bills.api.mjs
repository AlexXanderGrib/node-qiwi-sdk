...
class P2pBillsApi extends P2pApi {
     ...
     */
    async create(data) {
        const { paySource, successUrl, billId = this.generateId(), expirationDateTime = formatOffsetDate(15, "min"), ...bill } = data;
        const patchedBill = {
            ...bill,
            expirationDateTime,
            amount: {
    ...
    createFormUrl(parameters) {
        ...
        (_b = options.billId) !== null && _b !== void 0 ? _b : (options.billId = generateUUID());
