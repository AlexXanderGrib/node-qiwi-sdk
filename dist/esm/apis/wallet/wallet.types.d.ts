export declare enum PersonIdentificationLevel {
...
export declare type PersonIdentificationLevelPlain = keyof typeof PersonIdentificationLevel;
export declare type PersonIdentificationLevelAny = PersonIdentificationLevel | PersonIdentificationLevelPlain;
...
export declare type TransactionTypePlain = keyof typeof TransactionType;
export declare type TransactionTypeAny = TransactionType | TransactionTypePlain;
/** Статус платежа */
...
export declare type TransactionStatusPlain = keyof typeof TransactionStatus;
export declare type TransactionStatusAny = TransactionStatus | TransactionStatusPlain;
...
export declare type CurrencyPlain = keyof typeof Currency;
export declare type CurrencyAny = Currency | CurrencyPlain;
...
export declare type ChequeFormatPlain = keyof typeof ChequeFormat;
export declare type ChequeFormatAny = ChequeFormat | ChequeFormatPlain;
export declare enum Recipients {
    /** МТС */
    MTS = 1,
    /** Билайн */
    Beeline = 2,
...
export declare type IdentificationBase = {
...
export declare type IdentificationResponse = IdentificationBase & {
     ...
     * рождения.
     */
    type: PersonIdentificationLevel.SIMPLE | PersonIdentificationLevel.VERIFIED | PersonIdentificationLevel.FULL;
};
...
export declare enum PaymentHistorySource {
    /**
...
export declare type PaymentHistorySourcePlain = keyof typeof PaymentHistorySource;
export declare type PaymentHistorySourceAny = PaymentHistorySource | PaymentHistorySourcePlain;
export declare type GetPaymentHistoryParamsBase = {
    /**
...
export declare type GetPaymentHistoryParamsStartEnd = {
    /**
...
export declare type GetPaymentHistoryParams = GetPaymentHistoryParamsBase | (GetPaymentHistoryParamsBase & GetPaymentHistoryParamsStartEnd) | (GetPaymentHistoryParamsBase & {
    /**
...
export declare type GetPaymentHistoryTotalParams = Omit<GetPaymentHistoryParamsBase, "rows"> & GetPaymentHistoryParamsStartEnd;
export declare type GetPaymentHistoryTotalResponse = {
    /**
...
export declare type GetTransactionsHistoryResponse = {
    /**
...
export declare type LimitTypePlain = keyof typeof LimitType;
export declare type LimitTypeAny = LimitType | LimitTypePlain;
export declare type Limit<Cur extends keyof typeof Currency = "RUB", Type extends LimitTypeAny = LimitTypeAny> = {
    /** Валюта операций */
    currency: Cur;
    /**
...
export declare type LimitsResponse<RequestedLimits extends LimitTypeAny = LimitTypeAny> = {
    /** Описание лимитов */
    limits: {
...
export declare type AccountOffer = {
    /** Псевдоним счета */
    alias: string;
    /** ID валюты счета */
    currency: Currency;
};
export declare type GetAccountOffersResponse = AccountOffer[];
export declare type PaymentCommissionRequest = {
    /**
...
export declare type LockableField = "account" | "comment" | "sum";
export declare type FormUrlOptions = {
...
export declare type CardStatusPlain = keyof typeof CardStatus;
export declare type CardStatusAny = CardStatus | CardStatusPlain;
...
declare type NameValueObject = {
    name: string;
    value: string;
};
declare type CardType = "VIRTUAL" | "PLASTIC";
...
export declare type CardActionStatusPlain = keyof typeof CardActionStatus;
export declare type CardActionStatusAny = CardActionStatus | CardActionStatusPlain;
...
export declare type FreePayFields = {
    /**
 ...
 */
export declare type PayParameters = {
    /**
...
export declare enum CommissionPayer {
    RECEIVER = "RECEIVER",
    SENDER = "SENDER"
}
export declare type CommissionPayerPlain = keyof typeof CommissionPayer;
export declare type CommissionPayerAny = CommissionPayer | CommissionPayerPlain;
export declare enum QuickPayRecipients {
    Card = "card",
    Phone = "phone"
}
export declare type QuickPayRecipientsPlain = "card" | "phone" | "qiwi" | "yoomoney";
export declare type QuickPayRecipientsAny = QuickPayRecipients | QuickPayRecipientsPlain;
export declare type QuickPayParameters = Omit<PayParameters, "provider"> & {
 ...
 */
export declare type WebhookTransaction = {
...
export declare type BillsGetParameters = {
    /**
...
export declare type BillPayResponse = {
    /**
