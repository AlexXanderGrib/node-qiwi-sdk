 ...
 * @extends {P2p}
 */
class _P2pCompatBillPayments extends p2p.P2p {
  /**
   ...
   * @memberof _P2pCompatBillPaymentsUniversal
   */
  async refund(billId, refundId, amount = 0, currency = p2p_types.BillCurrency.RUB) {
...
exports._P2pCompatBillPayments = _P2pCompatBillPayments;
