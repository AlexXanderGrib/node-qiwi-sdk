...
var bills_api = require('./bills.api.js');
var cards_api = require('./cards.api.js');
var fundingSources_api = require('./funding-sources.api.js');
var identification_api = require('./identification.api.js');
var limits_api = require('./limits.api.js');
var paymentHistory_api = require('./payment-history.api.js');
var payments_api = require('./payments.api.js');
var personProfile_api = require('./person-profile.api.js');
var restrictions_api = require('./restrictions.api.js');
var webhooks_api = require('./webhooks.api.js');
var wallet_types = require('./wallet.types.js');
var querystring = require('querystring');
var identity = require('../../identity.js');
var wallet_errors = require('./wallet.errors.js');
var api = require('../api.js');
var providers_api = require('./providers.api.js');
...
class Wallet extends api.ApiClass {
     ...
     * @memberof Wallet
     */
    constructor({ token = "", walletId = "", http = Wallet.httpClientFactory(token) } = {}) {
    ...
    async createOauthToken() {
        const commonOptions = {
            ...
            stringifyBody: querystring.stringify
        };
