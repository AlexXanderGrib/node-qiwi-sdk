 ...
 * @extends {WalletApi}
 */
class WalletBillsApi extends api.WalletApi {
  /**
   * ## Выпуск токена P2P
   *
  ...
  async createP2PKeyPair(name, server) {
    ...
    const publicKey =
      (_b =
        (_a = response.result) === null || _a === void 0 ? void 0 : _a.publicKey) !==
        null && _b !== void 0
        ? _b
        : response.PublicKey;
    const secretKey =
      (_d =
        (_c = response.result) === null || _c === void 0 ? void 0 : _c.secretKey) !==
        null && _d !== void 0
        ? _d
        : response.SecretKey;
  ...
  async get(parameters = {}) {
    const { bills } = await this.http.get(
      `checkout-api/api/bill/search?${querystring.formatQuerystring(parameters)}`
    );
    return bills;
  }
  /**
...
exports.WalletBillsApi = WalletBillsApi;
