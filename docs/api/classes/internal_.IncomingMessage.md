[qiwi-sdk](../README.md) / [Exports](../modules.md) / [<internal\>](../modules/internal_.md) / IncomingMessage

# Class: IncomingMessage

[<internal>](../modules/internal_.md).IncomingMessage

An `IncomingMessage` object is created by [Server](internal_.Server.md) or {@link ClientRequest} and passed as the first argument to the `'request'` and `'response'` event respectively. It may be used to
access response
