[qiwi-sdk](../README.md) / [Exports](../modules.md) / [<internal\>](internal_.md) / internal
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `stream` | [`WritableStream`](../interfaces/internal_.WritableStream.md) \| [`ReadableStream`](../interfaces/internal_.ReadableStream.md) \| [`ReadWriteStream`](../interfaces/internal_.ReadWriteStream.md) | A readable and/or writable stream. |
